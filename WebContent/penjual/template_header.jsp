...
<body>
        <header>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light" >
                ...
                <div class="col-6" style="margin-right: 5rem;">
                            <div class="search_box pull-right" style="padding-right: 10rem;">
                ...
                <div class="navbar-collapse collapse" id="navbarNav"> 
                    ...
                    <c:if test="${!empty LoginUser && LoginUser.tipeakun =='ROLE_COSTUMER' }">
                                        <li class="nav-item" style="padding-right: 5rem;">
                                        ...
                                        <li class="nav-item" style="padding-right: 5rem;"><a href="#">
                    ...
                    <c:if test="${!empty LoginUser && LoginUser.tipeakun =='ROLE_ADMIN' }">
                    	<li class="nav-item" style="padding-right: 10rem;"><a href="/"><i class="fa fa-cog"></i> Panel Admin </a></li>
                    ...
                    <c:if test="${!empty LoginUser && LoginUser.tipeakun =='ROLE_SELLER' }">
                    	<li class="nav-item"><a href="ProfilPenjual"><i class="fa fa-user"></i> ${LoginUser.username}</a></li>
                    	<li class="nav-item"><a href="penjual"><i class="fa fa-cog"></i> Panel Penjual </a></li>
                    	<li class="nav-item"><a href="logoutpenjual"><i class="fa fa-sign-out"></i> Logout</a></li>
                    </c:if>

                    <c:if test="${empty LoginUser}">
                    <li class="nav-item" style="margin-left: 1050%">
                        <button class="btnd btn-secondary dropdown-toggle navbar-toggle" style="margin-bottom: 2%;" type="button" 
										  ...
										  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
										    ...
										    <a class="dropdown-item" href="loginpenjual.jsp">Penjual</a>
